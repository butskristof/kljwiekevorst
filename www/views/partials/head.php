    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-70900108-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-70900108-2');
    </script>
	...
	<link rel="mask-icon" href="/safari-pinned-tab.svg" color="#ed2920">
	<meta name="apple-mobile-web-app-title" content="KLJ Wiekevorst">
	<meta name="application-name" content="KLJ Wiekevorst">
